...
export const DetailCardSection = () => {
    return (
       <Box mt="4.5rem">
            <BackgroundWithTexture overflow="hidden" borderRadius="0 200px 0 0" linearGradient='linear-gradient(221deg, #3C70D8 2.88%, rgba(60, 112, 216, 0.00) 102.52%)'>
                ...
                <Box sx={{position:"absolute", top: {lg:0}, bottom:{xs:'0', lg:'auto'}, right: {xs:"-2rem", lg:0}, zIndex: 5}}>
                    <FlowerIcon />
                </Box>
